...
шаблона, заполненные, и на них гоняются 42 сценария в
...
| `test/integration/declared-joins.test.js` | 42 сценария на живом складе: поведение связей, заземление, генерация SQL, вызов через MCP, цепочка на все четыре источника |
