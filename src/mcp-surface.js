...
function coreInstructions({ apps = false, skillUris = [] } = {}) {
  return [
    ...
    'For an open research question — why a metric moved, what drives it, whether a change worked, a product / monetization / UA deep dive — read semantic_index({ guide: "research" }) first: the investigation sequence, the checks and a guide per domain.',
