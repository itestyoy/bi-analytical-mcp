...
test('invalidation is positional: an edit retires the checkpoints whose prefix contains that step', async () => {
  ...
  // The retired checkpoint's files are gone (nobody reads them); the live one's stay.
  assert.ok(!e.ctxs.hasPipelineModel(draft_id, c2.model), 'retired checkpoint model removed');
