...
export class Engine {
  ...
  _indexRun(input) {
    ...
    return {
      ...
      property_count: props.length,
      properties: props,
      // NB: per-property `ms` is only meaningful for properties scanned individually (batched
      // ones are ~0). Batch-fallback reasons are logged to stderr, not surfaced here.
      recommendations: [
