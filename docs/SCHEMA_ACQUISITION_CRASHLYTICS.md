...
шаблона, заполненные, и на них гоняются 36 сценариев в
...
| `test/integration/declared-joins.test.js` | 36 сценариев на живом складе: поведение связей, заземление, генерация SQL, вызов через MCP |
